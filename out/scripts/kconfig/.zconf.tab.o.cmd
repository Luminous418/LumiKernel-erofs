cmd_scripts/kconfig/zconf.tab.o := gcc -Wp,-MD,scripts/kconfig/.zconf.tab.o.d -Iscripts/kconfig -Wall -Wmissing-prototypes -Wstrict-prototypes -O3 -fomit-frame-pointer -std=gnu89 -DCURSES_LOC="<curses.h>" -DLOCALE  -I../scripts/kconfig -c -o scripts/kconfig/zconf.tab.o ../scripts/kconfig/zconf.tab.c
