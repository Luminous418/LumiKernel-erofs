 ...
 * Linux/arm64 4.14.356-openela-rc1-vigus Kernel Configuration
 *
 */
...
#define CONFIG_CMDLINE "console=tty0 console=ttyMT3,921600n1 root=/dev/ram vmalloc=496M slub_max_order=0 slub_debug=0 scsi_mod.use_blk_mq=1 dm_mod.use_blk_mq=1 nokaslr mitigations=off rcu_nocbs=0-5"
...
#define CONFIG_ALWAYS_PERMISSIVE 1
